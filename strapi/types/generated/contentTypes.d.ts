...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccionEnvio: Schema.Attribute.Text & Schema.Attribute.Required;
    emailCliente: Schema.Attribute.Email & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    nombreCliente: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    telefonoCliente: Schema.Attribute.String;
